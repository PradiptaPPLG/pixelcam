...
// Polyfill for GSAPSplitText (premium plugin) since it's not available in standard GSAP
...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  const splitRef = useRef<SplitTextPolyfill | null>(null);
  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        splitRef.current = new SplitTextPolyfill(el, {
      ...
      const play = () => {
        ...
        const addTween = (targets: any, at: any) => {
          ...
          if (isVertical) {
            vars.y = (i: any, t: any) => parseFloat(t.getAttribute('data-final-y') || '0');
          } else {
            vars.x = (i: any, t: any) => parseFloat(t.getAttribute('data-final-x') || '0');
          }
