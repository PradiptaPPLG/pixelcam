...
export default function PixelBlast({
  ...
  useEffect(() => {
    ...
    const cleanUpThree = (t: ThreeState) => {
      ...
      if (t.eventSource && t.onPointerDown && t.onPointerMove) {
        t.eventSource.removeEventListener("pointerdown", t.onPointerDown as any);
        t.eventSource.removeEventListener("pointermove", t.onPointerMove as any);
      }
    };
    ...
    if (mustReinit) {
      ...
      const eventSource = container.closest("section") || container.parentElement || renderer.domElement;

      eventSource.addEventListener("pointerdown", onPointerDown as any, {
        passive: true
      });
      eventSource.addEventListener("pointermove", onPointerMove as any, {
        passive: true
      });
