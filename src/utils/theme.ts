...
export const THEMES: ThemePreset[] = [
  ...
  // ── NEW: RPL / Developer / Tech Themes ─────────────────────────────
  {
    id: "vscode-dark",
    name: "VS Code Dark",
    emoji: "💻",
    description: "Official VS Code Editor palette with code syntax accents.",
    style: {
      paper: "#1E1E1E",
      paperPattern: `repeating-linear-gradient(90deg, transparent 0px, transparent 19px, rgba(255,255,255,0.03) 19px, rgba(255,255,255,0.03) 20px), #1E1E1E`,
      canvas: "#181818",
      photoBorder: "#007ACC",
      photoBorderWidth: 2,
      topLabel: "#9CDCFE",
      ...
      gap: 10,
      radius: 8,
      shadow: "0 24px 60px -16px rgba(0,122,204,0.40)",
      dark: true,
      mono: true,
    },
  },
  {
    ...
    name: "Cyber Matrix",
    emoji: "🟢",
    description: "RPL Hacker vibe. Terminal dark with phosphor green code grid.",
    style: {
      paper: "#050F08",
      paperPattern: `repeating-linear-gradient(0deg, transparent, transparent 15px, rgba(0,255,102,0.08) 15px, rgba(0,255,102,0.08) 16px), #050F08`,
      canvas: "#020804",
      photoBorder: "#00FF66",
      photoBorderWidth: 2,
      topLabel: "#00FF66",
      ...
      gap: 8,
      radius: 4,
      shadow: "0 0 35px rgba(0,255,102,0.30), 0 24px 60px rgba(0,0,0,0.7)",
      dark: true,
      mono: true,
    },
  },
  {
    ...
    name: "Dracula Dev",
    emoji: "🧛‍♂️",
    description: "Cult developer palette. Deep purple with pink & cyan syntax.",
    style: {
      paper: "#282A36",
      paperPattern: "linear-gradient(135deg, #282A36 0%, #1E1F29 100%)",
      canvas: "#191A21",
      photoBorder: "#BD93F9",
      photoBorderWidth: 2,
      topLabel: "#FF79C6",
      ...
      gap: 12,
      radius: 12,
      shadow: "0 24px 60px -16px rgba(189,147,249,0.35)",
      dark: true,
      mono: true,
    },
  },
  {
    ...
    emoji: "🐱",
    description: "Soothing pastel dark theme beloved by modern programmers.",
    style: {
      paper: "#1E1E2E",
      paperPattern: "linear-gradient(140deg, #1E1E2E 0%, #181825 100%)",
      canvas: "#11111B",
      photoBorder: "#89B4FA",
      photoBorderWidth: 2,
      topLabel: "#F5C2E7",
      ...
      gap: 12,
      radius: 16,
      shadow: "0 24px 60px -16px rgba(137,180,250,0.35)",
      dark: true,
      mono: true,
    },
  },
  {
    ...
    name: "RPL Cyber-Tech",
    emoji: "⚡",
    description: "High-voltage RPL tech theme. Neon cyan, fiery orange & magenta.",
    style: {
      paper: "#0B0C10",
      paperPattern: `linear-gradient(135deg, #0B0C10 0%, #1F2833 50%, #0B0C10 100%)`,
      canvas: "#070709",
      photoBorder: "#66FCF1",
      photoBorderWidth: 2,
      topLabel: "#66FCF1",
      ...
      gap: 10,
      radius: 6,
      shadow: "0 0 40px rgba(102,252,241,0.30), 0 24px 60px rgba(0,0,0,0.7)",
      dark: true,
      mono: true,
    },
  },
  {
    ...
    name: "VS Code Light",
    emoji: "🛠️",
    description: "Clean VS Code Light UI with slate gray, VS blue, and orange syntax.",
    style: {
      paper: "#F3F3F3",
      paperPattern: `repeating-linear-gradient(90deg, transparent 0px, transparent 19px, rgba(0,0,0,0.04) 19px, rgba(0,0,0,0.04) 20px), #F3F3F3`,
      canvas: "#E5E5E5",
      photoBorder: "#007ACC",
      photoBorderWidth: 2,
      topLabel: "#007ACC",
      ...
      gap: 10,
      radius: 8,
      shadow: "0 20px 50px -16px rgba(0,122,204,0.30)",
      mono: true,
    },
  },
  {
    ...
    name: "Android Studio",
    emoji: "🤖",
    description: "Android Dev theme. Clean white paper with Android Green & Jetpack Blue.",
    style: {
      paper: "#FFFFFF",
      paperPattern: "linear-gradient(135deg, #FFFFFF 0%, #F0FDF4 60%, #EFF6FF 100%)",
      canvas: "#F4F6F8",
      photoBorder: "#3DDC84",
      photoBorderWidth: 3,
      topLabel: "#191C1E",
      ...
      gap: 12,
      radius: 14,
      shadow: "0 20px 50px -16px rgba(61,220,132,0.32)",
      mono: true,
    },
  },
  {
    ...
    name: "PhpStorm Jet",
    emoji: "🐘",
    description: "JetBrains PhpStorm palette. Fiery red-to-purple gradient with slate gray.",
    style: {
      paper: "#212126",
      paperPattern: "linear-gradient(135deg, #FF2D55 0%, #B827FC 50%, #212126 90%)",
      canvas: "#151518",
      photoBorder: "#FF2D55",
      photoBorderWidth: 2,
      topLabel: "#FFFFFF",
      ...
      gap: 10,
      radius: 10,
      shadow: "0 24px 60px -16px rgba(255,45,85,0.40)",
      dark: true,
      mono: true,
    },
  },
  {
    ...
    name: "Adobe Bronze",
    emoji: "🎨",
    description: "Adobe Creative Suite warm bronze & rich brown design aesthetic.",
    style: {
      paper: "#2C221E",
      paperPattern: "linear-gradient(140deg, #3D2E28 0%, #2C221E 60%, #1A1310 100%)",
      canvas: "#17120F",
      photoBorder: "#D97706",
      photoBorderWidth: 2,
      topLabel: "#FDE68A",
      ...
      gap: 12,
      radius: 12,
      shadow: "0 24px 60px -16px rgba(217,119,6,0.35)",
      dark: true,
    },
  },
];
