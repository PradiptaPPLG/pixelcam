export const MAINTENANCE_CONFIG = {
  ...
  message:
    "PixelCam is currently undergoing scheduled application maintenance and optimization. For urgent inquiries, please contact us at pradipta02032009@gmail.com.",
  author: "Pradipta",
